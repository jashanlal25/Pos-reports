const SHELL='pos-business-shell-v13';const ASSETS=['/','/index.html','/app.mjs?v=14','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=14','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
