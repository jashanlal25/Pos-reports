const SHELL='pos-business-shell-v4';const ASSETS=['/','/index.html','/app.mjs?v=6','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=6','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
