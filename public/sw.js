const SHELL='pos-business-shell-v11';const ASSETS=['/','/index.html','/app.mjs?v=12','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=12','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
