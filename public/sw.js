const SHELL='pos-business-shell-v10';const ASSETS=['/','/index.html','/app.mjs?v=11','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=11','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
