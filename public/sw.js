const SHELL='pos-business-shell-v5';const ASSETS=['/','/index.html','/app.mjs?v=8','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=8','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
