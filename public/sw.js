const SHELL='pos-business-shell-v14';const ASSETS=['/','/index.html','/app.mjs?v=15','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=15','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
