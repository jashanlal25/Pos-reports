const SHELL='pos-business-shell-v15';const ASSETS=['/','/index.html','/app.mjs?v=16','/parser.mjs','/worker.mjs','/storage.mjs','/style.css?v=16','/manifest.webmanifest','/icon-192.png','/icon-512.png','/nexus-pulse-hero.png?v=1'];
