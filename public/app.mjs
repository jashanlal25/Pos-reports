...
function showDetails(code){
 ...
 $('detailBody').innerHTML=accountSection+invoiceSection+'<details class="raw-fields"><summary>Original POS backup fields</summary><p>Technical account fields stored in the backup.</p><div class="raw-grid">'+Object.entries(r.raw||{}).map(([k,v])=>`<div><b>${esc(k)}</b>${esc(v===''?'—':v)}</div>`).join('')+'</div></details>';$('detailDialog').showModal();
}
